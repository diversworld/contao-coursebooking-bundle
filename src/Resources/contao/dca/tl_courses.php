...
$GLOBALS['TL_DCA']['tl_courses'] = array(
    ...
    'edit'        => array(
        'buttons_callback' => array(
            array('tl_courses', 'buttonsCallback')
        )
    ),
    'list'        => array(
        'sorting'           => array(
    ...
    'fields'      => array(
        ...
        'selectField'    => array(
            ...
            'filter'    => true,
            'sorting'   => true,
            'reference' => $GLOBALS['TL_LANG']['tl_courses'],
...
class tl_courses extends Backend
{
    ...
    public function buttonsCallback($arrButtons, DC_Table $dc)
    {
        ...
        {
            $arrButtons['customButton'] = '<button type="submit" name="customButton" id="customButton" class="tl_submit customButton" accesskey="x">' . $GLOBALS['TL_LANG']['tl_courses']['customButton'] . '</button>';
        }
