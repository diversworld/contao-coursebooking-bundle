...
namespace Diversworld\ContaoCoursebookingBundle\Controller\FrontendModule;
...
/**
 * Class CoursesModuleController
 *
 * @FrontendModule(CoursesModuleController::TYPE, category="courses_list", template="mod_courses_module")
 */
class CoursesModuleController extends AbstractFrontendModuleController
{
    public const TYPE = 'courses_module';
